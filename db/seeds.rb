...
sloan = User.create(email: 'sloan.holzman@gmail.com', password: 'password', first_name: 'sloan', last_name: 'holzman')
bob = User.create(email: 'bob@gmail.com', password: 'password', first_name: 'bob', last_name: 'johnson')
billy = User.create(email: 'billy@gmail.com', password: 'password', first_name: 'billy', last_name: 'johnson')
